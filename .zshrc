...
plugins=(git npm dotenv zsh-autosuggestions)
...
export XDG_DATA_DIRS="$XDG_DATA_DIRS:/var/lib/snapd/snap/bin"
...
# alias ktheme="cd ~/.config/kitty/kitty-themes && fzf --preview 'head -n 40 {} && kitty @ --to $KITTY_LISTEN_ON set-colors -a -c {}'; cd -"
